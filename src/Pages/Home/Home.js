...
import { Avatar, Hero, Mask, Stats } from "react-daisyui";
...
const Home = () => {
  return (
    <div className="flex container mx-auto py-24 ">
      <div className="w-1/2 flex flex-col justify-center items-start text-base-300 ">
        ...
        <p className="text-start mt-10 font-medium">
          ...
          labore quam, a neque libero quos corrupti nemo deleniti iusto aperiam
          accusantium rerum placeat laborum hic dicta commodi alias nobis
          quisquam nulla minus doloremque repellat obcaecati perspiciatis
          architecto! Mollitia, molestiae corrupti.
        </p>
      </div>
